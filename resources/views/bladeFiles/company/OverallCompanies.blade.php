            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="text-center card-box">
                        <div class="member-card pt-2 pb-2" style="border:2px solid #fcd53b;">
                            ...
                            -->
                            <i class="mdi mdi-account-check" style="color:#46c35f;font-size:22px;"></i>
                           
                                <a href="{{url('company/profile/get/'.Crypt::encrypt($companyDtls->id))}}"><i class="mdi mdi-eye" style="color:#6610f2;font-size:22px;"></i></a>
                           ...
                           <!-- <div class="mt-4">
                                <div class="row">
                                    <div class="col-4">
                                        <div class="mt-3">
                                            <h4>2</h4>
                                            <p class="mb-0 text-muted">Employee</p>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="mt-3">
                                            <h4>{{$companyDtls->project_done ?? 1}}</h4>
                                    ...
                                    <div class="col-4">
                                        <div class="mt-3">
                                            <h4>2</h4>
                                            <p class="mb-0 text-muted">Job Posted</p>
                                        </div>
                                    </div>
                                </div>
                            </div>-->
